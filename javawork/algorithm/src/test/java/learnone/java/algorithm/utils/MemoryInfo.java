package learnone.java.algorithm.utils;
...
public class MemoryInfo {
    ...
    public static final String GMKiB = "Mib";
    ...
    public static void print() {
        ...
        sb.append(LEFT);
        sb.append(
                String.format(FORMAT, String.valueOf(hu >> BIT), String.valueOf(hc >> BIT), String.format("%.2f%%", 1.0 * hu / hc * 100))
        ).append(MID);
        sb.append(
                String.format(FORMAT, String.valueOf(nu >> BIT), String.valueOf(nc >> BIT), String.format("%.2f%%", 1.0 * nu / nc * 100))
        ).append(RIGHT + "\n");
        System.out.print(sb);
    }
